...
// global variables
string pose_file = "/home/jixingwu/Thirdpart/slam_deepBule/PA7/3/poses.txt";
string points_file = "/home/jixingwu/Thirdpart/slam_deepBule/PA7/3/points.txt";
...
public:
    ...
    virtual void computeError() override {
        ...
        Eigen::Vector3d Pc = vertexTcw->estimate()*vertexTve->estimate();
...
int main(int argc, char **argv) {
    ...
    boost::format fmt("/home/jixingwu/Thirdpart/slam_deepBule/PA7/3/%d.png");
    for (int i = 0; i < 7; i++) {
    ...
    for (int c = 0; c < poses.size(); ++c) {
        for (int p = 0; p < points.size(); ++p) {
            EdgeDirectProjection* edge = new EdgeDirectProjection(color[p], image[c]);
